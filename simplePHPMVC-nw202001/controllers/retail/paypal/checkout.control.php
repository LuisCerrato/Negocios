...
function createPaypalTransacction( $_amount , $_items )
{
    ...
    $redirectUrls
        ->setReturnUrl("http://localhost/carreta/simplePHPMVC-nw202001/index.php?page=checkoutapr")
        ->setCancelUrl("http://localhost/carreta/simplePHPMVC-nw202001/index.php?page=checkoutcnl");
